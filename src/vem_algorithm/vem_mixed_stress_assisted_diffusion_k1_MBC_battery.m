function [zetah,phih,info] = vem_mixed_stress_assisted_diffusion_k1_MBC_battery(node,elem,pde,bdStruct,m0,m1,info_stress)
...
if ~isempty(bdEdgeN)
    ...
    sol(bdDofN) = [0*zeta_N(bde1N);0*zeta_N(bde2N)];

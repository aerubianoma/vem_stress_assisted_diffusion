function [ErruL2,ErrpL2,uL2,pL2,h] = error_V2_Q2_k1(node,elem,zetah,phih,info,pde,M)
...
for iel = 1:NT
    ...
    pmK = @(x,y) phih(loc_dof(1),1)*m1(x,y)+phih(loc_dof(2),1)*m2(x,y)+phih(loc_dof(3),1)*m3(x,y);
    damk = @(x,y) [m1(x,y),m2(x,y),m3(x,y)]*div{iel}*chi{iel};

...
% add ./2 only for mu!
showrate_robust(h,errors_V1_Q1,errors_V2_Q2,variation,M_values,variable_string,'$M$')

%error_robust_file = strcat('robust_plot_',mesh_type,variable_string,'.fig');
%saveas(gcf, fullfile('fancy_plots/k21', error_robust_file));

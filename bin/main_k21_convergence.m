...
for actual_mesh = 1:maxIt
    ...
    saveas(gcf, fullfile('../outputs/graphs/',mesh_type,'/k21', stress_file));
    ...
    saveas(gcf, fullfile('../outputs/graphs/',mesh_type,'/k21', diffusion_file));
...
filename = strcat('../outputs/tables/',mesh_type,'/k21_');

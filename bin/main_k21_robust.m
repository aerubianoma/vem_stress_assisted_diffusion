...
%% LINES TO BE CHANGED For different experiments
...
for c = 1:size(variation,1)
    ...
    %% Variable to check robustness - CHANGE STRING ALWAYS!!!
...
showrate_robust(h,total_Err,variation,M_values,variable_string,'$M$',2)
